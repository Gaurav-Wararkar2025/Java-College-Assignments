...
8.Define an interface named Filterable with abstract methods like apply_filter(filter_type) and reset_filter().

Create  two classes, ImageProcessor and DataAnalyzer, both implement the Filterable interface.

Implement the methods in each class to perform distinct actions relevant to image and data processing respectively, showcasing a shared contract with different implementations.
